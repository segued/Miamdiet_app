        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <div class="app-branding text-center">
                <a class="app-logo" href="{{ route('dashboard') }}">
                    <img class="logo-icon me-2" src="{{ asset('miamdiet/images/logo.svg') }}" alt="logo" />
                </a>
                <span class="logo-text">Miamdiet</span>
            </div>
                ...
                <ul class="app-menu list-unstyled accordion " id="menu-accordion">
                        ...
                        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item">
                                    <a class="submenu-link" href="{{ route('produit.create') }}"><i class="fas fa-plus-circle"></i> Ajouter</a>
                                </li>
                                <li class="submenu-item">
                                    <a class="submenu-link" href="{{ route('produit.index') }}"><i class="fas fa-list"></i> Liste</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item has-submenu">
                        ...
                        <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item">
                                    <a class="submenu-link" href="{{ route('category.create') }}"><i class="fas fa-folder-plus"></i> Ajouter</a>
                                </li>
                                <li class="submenu-item">
                                    <a class="submenu-link" href="{{ route('category.index') }}"><i class="fas fa-folder-open"></i> Liste</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item has-submenu">
                        ...
                        <div id="submenu-5" class="collapse submenu submenu-5" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item">
                                    <a class="submenu-link" href="{{ route('book.create') }}"><i class="fas fa-folder-plus"></i> Ajouter</a>
                                </li>
                                <li class="submenu-item">
                                    <a class="submenu-link" href="{{ route('book.index') }}"><i class="fas fa-folder-open"></i> Liste</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('temoignage.index') }}">
                            ...
                            <span class="nav-link-text">Temoignages</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item has-submenu">
                        <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-3" aria-expanded="false" aria-controls="submenu-3">
                            ...
                            <span class="nav-link-text">Gestionnaire</span>
                            <span class="submenu-arrow">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                                </svg>
                        ...
                        <div id="submenu-3" class="collapse submenu submenu-3" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item">
                                    <a class="submenu-link" href="{{ route('gestionnaire.create') }}"><i class="fas fa-folder-plus"></i> Ajouter</a>
                                </li>
                                <li class="submenu-item">
                                    <a class="submenu-link" href="{{ route('gestionnaire.index') }}"><i class="fas fa-folder-open"></i> Liste</a>
                                </li>
                            </ul>
                        </div>
                    </li>
