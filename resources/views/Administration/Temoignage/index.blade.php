...
<div class="row">
    ...
    <div class="container mb-4" style="background-color: #28a745; padding: 20px; border-radius: 5px;">
        <div class="row">
            <div class="col-6">
                <h1 class="mb-2 page-title" style="color: white;">Liste des temoignages</h1>
            </div>
            <div class="col-6 text-end">
                <a class="btn btn-primary text-white mb-3" href="{{ route('temoignage.create') }}" style="margin-top: 10px; background-color: transparent;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                    </svg> Ajouter un temoignage
                </a>
            </div>
        </div>
    </div>
                                ...
                                @foreach ($temoignages as $temoignage)
                                    <tr>
                                        ...
                                        <td class="cell">
                                            ...
                                            <a href="{{ route('temoignage.show', $temoignage->id) }}" title="Visualiser le temoignage" class="mx-1">
                                            ...
                                            <a href="{{ route('temoignage.edit', $temoignage->id) }}" title="Modifier le temoignage" class="mx-1">
                                            ...
                                            <span   title="Supprimer le temoignage" style="cursor:pointer ;" >
