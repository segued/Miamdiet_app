    ...
    <div class="row g-4 mb-4">
        <div class="col-6 col-lg-3">
            <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                    <h4 class="stats-type mb-1">Total des produits</h4>
                    <div class="stats-figure">{{ $totalproduits }}</div>
                    <h6 class="stats-type mb-1"><a href="{{route('produit.index')}}">Voir</a></h6>
        ...
        <div class="col-6 col-lg-3">
            <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                    <h4 class="stats-type mb-1">Total des categories</h4>
                    <div class="stats-figure">{{ $totalcategories }}</div>
                    <h6 class="stats-type mb-1"><a href="{{route('category.index')}}">Voir</a></h6>
        ...
        <div class="col-6 col-lg-3">
            <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                    <h4 class="stats-type mb-1">Total des Commandes</h4>
                    <div class="stats-figure">{{ $totalcommande }}</div>
                    <h6 class="stats-type mb-1"><a href="{{route('commande.index')}}">Voir</a></h6>
        ...
        <div class="col-6 col-lg-3">
            <div class="app-card app-card-stat shadow-sm h-100">
                <div class="app-card-body p-3 p-lg-4">
                    <h4 class="stats-type mb-1">Total des Rendez-vous</h4>
                    <div class="stats-figure">{{ $totalrdv }}</div>
                    <h6 class="stats-type mb-1"><a href="{{route('rendezvous')}}">Voir</a></h6>
