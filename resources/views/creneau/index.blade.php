...
<div class="container mb-4" style="background-color: #28a745; padding: 20px; border-radius: 5px;">
    <div class="row">
        <div class="col-6">
            <h1 class="mb-2 page-title" style="color: white;">Liste des Creneaux</h1>
        </div>
        <div class="col-6 text-end">
            <a class="btn btn-primary text-white mb-3" href="{{ route('creneau.create') }}" style="margin-top: 10px; background-color: transparent;">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                </svg> Ajouter un Creneau
            </a>
        </div>
    </div>
</div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    ...
                                    <a href="{{route('category.show', $categorie->id)}}" title="Visualiser la categorie" class="mx-1">
                                    ...
                                    <a href="{{route('category.edit', $categorie->id)}}" title="Modifier la categorie" class="mx-1">
                                    ...
                                    <span   title="Supprimer le categorie" style="cursor:pointer ;" >
                    ...
                    <table class="table datatables" id="dataTable-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    <div class="d-flex justify-content-start ">
                                    <a href="{{ route('creneau.edit', $creneau->id) }}" title="Modifier le creneau" class="mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square text-warning" viewBox="0 0 16 16">
                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                        </svg>
                                    </a>
                                    <span   title="Supprimer le creneau" style="cursor:pointer ;" >
                                        <form action="{{route('creneau.destroy', $creneau->id)}}" method="POST" >
                                            @csrf
                                            @method('delete')
                                            <a  id="confirmation" class="mx-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill text-danger" viewBox="0 0 16 16">
